...
namespace common {
    namespace drivers {
        namespace crc8 {
            ...
            uint8_t
            get_CRC8_check_sum(uint8_t* pch_message, unsigned int dw_length, uint8_t ucCRC8) {
                uint8_t uc_index;
                while (dw_length--) {
            ...
            void append_CRC8_check_sum(uint8_t* pch_message, unsigned int dw_length) {
                ...
                uc_crc = get_CRC8_check_sum(
                    reinterpret_cast<uint8_t*>(pch_message),
                    dw_length - 1,
                    CRC8_INIT
                );
        ...
        namespace crc16 {
            ...
            void append_CRC16_check_sum(uint8_t* pchMessage, uint32_t dwLength) {
                ...
                w_crc = get_CRC16_check_sum(
                    reinterpret_cast<uint8_t*>(pchMessage),
                    dwLength - 2,
                    CRC16_INIT
                );
