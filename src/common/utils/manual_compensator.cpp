...
#include "common/utils/manual_compensator.hpp"
namespace wust_vl {
namespace common {
    namespace utils {
        ...
        std::vector<double>
        ManualCompensator::angleHardCorrect(const double dist, const double height) {
            auto target_dist_node = std::find_if(
                angle_offset_map_.begin(),
                angle_offset_map_.end(),
            ...
            if (target_dist_node != angle_offset_map_.end()) {
                ...
                if (target_height_node != target_dist_node->height_map.end()) {
                    return { target_height_node->pitch_offset + base_pitch_,
